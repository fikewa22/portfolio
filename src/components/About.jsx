  ...
  return (
    <div className="md:mt-56 md:px-10 sm:mt-24 px-7" id="about">
      ...
      <p className="my-3 text-l text-black md:text-justify md:w-2/3 leading-[2]">
        ...
        excelling as a Frontend Developer.I specialize in crafting captivating
        user interfaces with HTML, CSS, and JavaScript, while also utilizing
        frameworks like ReactJS and NextJS. My skills extend to creating
        responsive designs with Bootstrap, practicing version control with Git
        and GitHub, and collaborating seamlessly within teams for efficient web
        development.
      </p>
      {/* experience section */}
      ...
      <div className="flex flex-col md:flex-row">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="md:w-[256px] md:h-[254px] bg-primary hover:bg-tertiary flex flex-col items-baseline justify-end my-3 md:m-3 p-5 shadow-sm transition-all duration-500 hover:-rotate-3 hover:scale-110"
          >
            <img src={skill.image} alt="Abdul-Qudus Olatunji" />
