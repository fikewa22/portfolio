...
const Home = () => {
    return (
        <div className='md:px-10 px-7 my-14 md:h-screen bg-[#6495ED]' id='home'>
            <div>
                <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                    ...
                    <div className='text-black'>
                        ...
                        <div className='mt-5'>
                            ...
                            {/* <button className='btn outline py-1.5 px-6 rounded border-none ml-5 text-black '>Projects</button> */}
                        </div>
                    </div>
                    {/* img */}
